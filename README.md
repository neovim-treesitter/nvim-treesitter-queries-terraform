# nvim-treesitter-queries-terraform

[![Validate Queries](https://github.com/neovim-treesitter/nvim-treesitter-queries-terraform/actions/workflows/validate.yml/badge.svg)](https://github.com/neovim-treesitter/nvim-treesitter-queries-terraform/actions/workflows/validate.yml)

Neovim tree-sitter queries for **terraform**, part of the
...
```jsonc
{
  ...
  "url": "https://github.com/tree-sitter/tree-sitter-terraform",
...
- [ ] Changes are scoped to `terraform` — do not include files for other languages
